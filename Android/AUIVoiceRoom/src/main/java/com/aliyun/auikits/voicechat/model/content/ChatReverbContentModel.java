...
public class ChatReverbContentModel extends AbsContentModel<CardEntity> {
    ...
    private ChatSoundMix[] effectArray = new ChatSoundMix[] {
            ...
            new ChatSoundMix("2", R.string.voicechat_reverb_rensheng, R.drawable.voicechat_ic_reverb_rensheng),
            new ChatSoundMix("3", R.string.voicechat_reverb_rensheng2, R.drawable.voicechat_ic_reverb_rensheng2),
            new ChatSoundMix("4", R.string.voicechat_reverb_zaotang, R.drawable.voicechat_ic_reverb_zaotang),
            new ChatSoundMix("5", R.string.voicechat_reverb_minglaing, R.drawable.voicechat_ic_reverb_minglaing),
            new ChatSoundMix("6", R.string.voicechat_reverb_heian, R.drawable.voicechat_ic_reverb_heian),
            new ChatSoundMix("7", R.string.voicechat_reverb_dafangjian, R.drawable.voicechat_ic_reverb_dafangjian),
            new ChatSoundMix("8", R.string.voicechat_reverb_zhongdeng, R.drawable.voicechat_ic_reverb_zhongdeng),
            new ChatSoundMix("9", R.string.voicechat_reverb_zoulang, R.drawable.voicechat_ic_reverb_zouliang),
    };

...
@objcMembers open class AUIVoiceRoomInfo: AUIRoomInfo {
    ...
    public override init(_ roomId: String, _ anchor: AUIRoomUser) {
...
@objcMembers open class AUIVoiceRoomMicSeatInfo: AUIRoomMicInfo {
    
    open override var user: AUIRoomUser? {
        didSet {
            if self.user == nil {
                // 设置下麦后初始状态
    ...
    private var _networkStatus: AUIRoomNetworkState = .Unknow
    open var networkStatus: AUIRoomNetworkState {
        get {
